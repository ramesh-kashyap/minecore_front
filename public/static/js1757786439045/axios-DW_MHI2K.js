...
const Bt = e => {
    ...
    De = ((e, t) => e ? setImmediate : t ? ((n, r) => (L.addEventListener("message", ({
        source: s,
        data: o
    }) => {
    ...
    kt = typeof queueMicrotask < "u" ? queueMicrotask.bind(L) : typeof process < "u" && process.nextTick || De,
    a = {
        isArray: U,
        isArrayBuffer: Ne,
        isBuffer: Ye,
...
function G(e, t, n) {
    ...
    function l(p, y, h) {
        ...
        if (p && !h && typeof p == "object") {
            ...
            else if (a.isArray(p) && qt(p) || (a.isFileList(p) || a.endsWith(y, "[]")) && (w = a.toArray(p))) return y = je(y), w.forEach(function(g, P) {
                !(a.isUndefined(g) || g === null) && t.append(i === !0 ? me([y], P, o) : i === null ? y : y + "[]", u(g))
            }), !1
        }
...
const I = {
    ...
    transformRequest: [function(t, n) {
        const r = n.getContentType() || "",
            ...
            o = a.isObject(t);
        if (o && a.isHTMLForm(t) && (t = new FormData(t)), a.isFormData(t)) return s ? JSON.stringify(Me(t)) : t;
...
const V = (e, t, n = 3) => {
    ...
    Re = e => (...t) => a.asap(() => e(...t)),
    un = O.hasStandardBrowserEnv ? ((e, t) => n => (n = new URL(n, O.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(new URL(O.origin), O.navigator && /(msie|trident)/i.test(O.navigator.userAgent)) : () => !0,
...
const Ve = e => {
        ...
        t.headers = i = A.from(i), t.url = He(Je(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : "")));
        let f;
        if (a.isFormData(n)) {
    ...
    ve = {
        getAdapter: e => {
            ...
            for (let o = 0; o < t; o++) {
                n = e[o];
                let i;
                if (r = n, !Tn(n) && (r = ae[(i = String(n)).toLowerCase()], r === void 0)) throw new m(`Unknown adapter '${i}'`);
                if (r) break;
                s[i || "#" + o] = r
            }
            if (!r) {
...
function Ae(e) {
    return ne(e), e.headers = A.from(e.headers), e.data = te.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), ve.getAdapter(e.adapter || I.adapter)(e).then(function(r) {
        return ne(e), r.data = te.call(e, e.transformResponse, r), r.headers = A.from(r.headers), r
    }, function(r) {
        return ze(r) || (ne(e), r && r.response && (r.response.data = te.call(e, e.transformResponse, r.response), r.response.headers = A.from(r.response.headers))), Promise.reject(r)
    })
}
const Xe = "1.7.9",
    Z = {};
...
Z.transitional = function(t, n, r) {
    ...
    return (o, i, c) => {
        ...
        return n && !xe[i] && (xe[i] = !0, console.warn(s(i, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(o, i, c) : !0
    }
};
