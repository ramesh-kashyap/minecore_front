...
(function(k, P) {
    (function(_, g) {
        ...
        return function() {
            var x = {
                    686: function(c, u, t) {
                        ...
                        var R = function(n, e) {
                            ...
                            j = function(n) {
                                var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {
                                    ...
                                    r = "";
                                return typeof n == "string" ? r = R(n, e) : n instanceof HTMLInputElement && !["text", "search", "url", "tel", "password"].includes(n == null ? void 0 : n.type) ? r = R(n.value, e) : (r = m()(n), d("copy")), r
                            },
                            C = j;
                        ...
                        var D = function() {
                                ...
                                if (a !== void 0)
                                    if (a && w(a) === "object" && a.nodeType === 1) {
                                        if (r === "copy" && a.hasAttribute("disabled")) throw new Error('Invalid "target" attribute. Please use "readonly" instead of "disabled" attribute');
                                        if (r === "cut" && (a.hasAttribute("readonly") || a.hasAttribute("disabled"))) throw new Error(`Invalid "target" attribute. You can't cut text from elements with "readonly" or "disabled" attributes`)
                                    } else throw new Error('Invalid "target" value, use a valid Element');
                                if (b) return C(b, {
                                    container: o
                                });
                                if (a) return r === "cut" ? p(a) : C(a, {
                                    container: o
                                })
                            },
                            F = D;
                        ...
                        function I(i, n, e) {
                            return n && N(i.prototype, n), e && N(i, e), i
                        }
                        ...
                        function Y(i, n) {
                            return n && (S(n) === "object" || typeof n == "function") ? n : G(i)
                        }
                        ...
                        var X = function(i) {
                                ...
                                function e(r, o) {
                                    var a;
                                    return H(this, e), a = n.call(this), a.resolveOptions(o), a.listenClick(r), a
                                }
                                return I(e, [{
                                    key: "resolveOptions",
                                    value: function() {
                    ...
                    828: function(c) {
                        ...
                        function f(s, l) {
                            for (; s && s.nodeType !== u;) {
                                if (typeof s.matches == "function" && s.matches(l)) return s;
                                s = s.parentNode
                            }
                        }
                        c.exports = f
                    ...
                    438: function(c, u, t) {
                        ...
                        function h(y, m, d, v) {
                            return function(p) {
                                p.delegateTarget = f(p.target, m), p.delegateTarget && v.call(y, p)
                            }
                        }
                        c.exports = l
                    },
                    879: function(c, u) {
                        u.node = function(t) {
                            ...
                            return t !== void 0 && (f === "[object NodeList]" || f === "[object HTMLCollection]") && "length" in t && (t.length === 0 || u.node(t[0]))
                        }, u.string = function(t) {
                    ...
                    370: function(c, u, t) {
                        ...
                        function l(d, v, p) {
                            ...
                            if (!f.string(v)) throw new TypeError("Second argument must be a String");
                            if (!f.fn(p)) throw new TypeError("Third argument must be a Function");
                            if (f.node(d)) return h(d, v, p);
                            if (f.nodeList(d)) return y(d, v, p);
                            if (f.string(d)) return m(d, v, p);
                    ...
                    817: function(c) {
                        function u(t) {
                            var f;
                            if (t.nodeName === "SELECT") t.focus(), f = t.value;
                            else if (t.nodeName === "INPUT" || t.nodeName === "TEXTAREA") {
                                var s = t.hasAttribute("readonly");
                                s || t.setAttribute("readonly", ""), t.select(), t.setSelectionRange(0, t.value.length), s || t.removeAttribute("readonly"), f = t.value
                            } else {
                                t.hasAttribute("contenteditable") && t.focus();
                                var l = window.getSelection(),
                                    h = document.createRange();
                                h.selectNodeContents(t), l.removeAllRanges(), l.addRange(h), f = l.toString()
                            }
                            return f
                        }
                        c.exports = u
                    ...
                    279: function(c) {
                        ...
                        u.prototype = {
                            ...
                            once: function(t, f, s) {
                                ...
                                function h() {
                                    l.off(t, h), f.apply(s, arguments)
                                }
                                return h._ = f, this.on(t, h, s)
                            },
                            emit: function(t) {
                                var f = [].slice.call(arguments, 1),
                                    s = ((this.e || (this.e = {}))[t] || []).slice(),
                                    l = 0,
                                    h = s.length;
                                for (l; l < h; l++) s[l].fn.apply(s[l].ctx, f);
                                return this
                            },
                            off: function(t, f) {
                                var s = this.e || (this.e = {}),
                                    ...
                                    h = [];
                                if (l && f)
                                    for (var y = 0, m = l.length; y < m; y++) l[y].fn !== f && l[y].fn._ !== f && h.push(l[y]);
                                return h.length ? s[t] = h : delete s[t], this
                            }
            ...
            function g(c) {
                if (_[c]) return _[c].exports;
                var u = _[c] = {
                    exports: {}
                };
                return x[c](u, u.exports, g), u.exports
            }
            return function() {
                    g.n = function(c) {
                        var u = c && c.__esModule ? function() {
                            return c.default
                        } : function() {
                            return c
                        };
                ...
                function() {
                    g.d = function(c, u) {
                        for (var t in u) g.o(u, t) && !g.o(c, t) && Object.defineProperty(c, t, {
                            enumerable: !0,
                            get: u[t]
                        })
                    }
