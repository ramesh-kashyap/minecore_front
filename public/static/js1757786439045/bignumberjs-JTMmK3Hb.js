var Ee = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i,
    ...
    y = Math.floor,
    C = "[BigNumber Error] ",
    ge = C + "Number primitive has more than 15 significant digits: ",
    H = 1e14,
    N = 14,
    pe = 9007199254740991,
    ae = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13],
    J = 1e7,
    k = 1e9;
...
function we(O) {
    ...
    function h(e, r) {
        ...
        if (r == null) {
            ...
            if (v(r, 2, K.length, "Base"), r == 10 && fe) return o = new h(e), G(o, x + o.e + 1, S);
            if (u = String(e), n = typeof e == "number") {
                if (e * 0 != 0) return R(o, u, n, r);
                if (o.s = 1 / e < 0 ? (u = u.slice(1), -1) : 1, h.DEBUG && u.replace(/^0\.0*|\./, "").length > 15) throw Error(ge + e)
            } else o.s = u.charCodeAt(0) === 45 ? (u = u.slice(1), -1) : 1;
        ...
        if (u = u.slice(c, ++f)) {
            if (f -= c, n && h.DEBUG && f > 15 && (e > pe || e !== y(e))) throw Error(ge + o.s * e);
            if ((l = l - c - 1) > z) o.c = o.e = null;
            else if (l < Q) o.c = [o.e = 0];
            else {
                if (o.e = l, o.c = [], c = (l + 1) % N, l < 0 && (c += N), c < f) {
                    for (c && o.c.push(+u.slice(0, c)), f -= N; c < f;) o.c.push(+u.slice(c, c += N));
    ...
    h.clone = we, h.ROUND_UP = 0, h.ROUND_DOWN = 1, h.ROUND_CEIL = 2, h.ROUND_FLOOR = 3, h.ROUND_HALF_UP = 4, h.ROUND_HALF_DOWN = 5, h.ROUND_HALF_EVEN = 6, h.ROUND_HALF_CEIL = 7, h.ROUND_HALF_FLOOR = 8, h.EUCLID = 9, h.config = h.set = function(e) {
        ...
        if (e != null)
            if (typeof e == "object") {
                if (e.hasOwnProperty(r = "DECIMAL_PLACES") && (i = e[r], v(i, 0, k, r), x = i), e.hasOwnProperty(r = "ROUNDING_MODE") && (i = e[r], v(i, 0, 8, r), S = i), e.hasOwnProperty(r = "EXPONENTIAL_AT") && (i = e[r], i && i.pop ? (v(i[0], -1e9, 0, r), v(i[1], 0, k, r), L = i[0], U = i[1]) : (v(i, -1e9, k, r), L = -(U = i < 0 ? -i : i))), e.hasOwnProperty(r = "RANGE"))
                    if (i = e[r], i && i.pop) v(i[0], -1e9, -1, r), v(i[1], 1, k, r), Q = i[0], z = i[1];
                    else if (v(i, -1e9, k, r), i) Q = -(z = i < 0 ? -i : i);
                else throw Error(C + r + " cannot be zero: " + i);
                if (e.hasOwnProperty(r = "CRYPTO"))
                    if (i = e[r], i === !!i)
                        if (i)
                            if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) Z = i;
                            else throw Z = !i, Error(C + "crypto unavailable");
                else Z = i;
                else throw Error(C + r + " not true or false: " + i);
                ...
                if (e.hasOwnProperty(r = "ALPHABET"))
                    if (i = e[r], typeof i == "string" && !/^.?$|[+\-.\s]|(.).*\1/.test(i)) fe = i.slice(0, 10) == "0123456789", K = i;
                    else throw Error(C + r + " invalid: " + i)
        ...
        if (s === null && t === null && (l === null || l === 1 || l === -1)) return !0;
        ...
        return function(i) {
            var s, t, l, c, n, f = 0,
                u = [],
                o = new h(T);
            if (i == null ? i = x : v(i, 0, k), c = ce(i / N), Z)
                if (crypto.getRandomValues) {
                    for (s = crypto.getRandomValues(new Uint32Array(c *= 2)); f < c;) n = s[f] * 131072 + (s[f + 1] >>> 11), n >= 9e15 ? (t = crypto.getRandomValues(new Uint32Array(2)), s[f] = t[0], s[f + 1] = t[1]) : (u.push(n % 1e14), f += 2);
                    f = c / 2
                } else if (crypto.randomBytes) {
                for (s = crypto.randomBytes(c *= 7); f < c;) n = (s[f] & 31) * 281474976710656 + s[f + 1] * 1099511627776 + s[f + 2] * 4294967296 + s[f + 3] * 16777216 + (s[f + 4] << 16) + (s[f + 5] << 8) + s[f + 6], n >= 9e15 ? crypto.randomBytes(7).copy(s, f) : (u.push(n % 1e14), f += 7);
                f = c / 7
            } else throw Z = !1, Error(C + "crypto unavailable");
            if (!Z)
                for (; f < c;) n = r(), n < 9e15 && (u[f++] = n % 1e14);
            for (c = u[--f], i %= N, c && i && (n = ae[N - i], u[f] = y(c / n) * n); u[f] === 0; u.pop(), f--);
            if (f < 0) u = [l = 0];
            else {
        ...
        function r(i, s, t, l) {
            for (var c, n = [0], f, u = 0, o = i.length; u < o;) {
                ...
                for (n[0] += l.indexOf(i.charAt(u++)), c = 0; c < n.length; c++) n[c] > t - 1 && (n[c + 1] == null && (n[c + 1] = 0), n[c + 1] += n[c] / t | 0, n[c] %= t)
            }
            return n.reverse()
        }
        return function(i, s, t, l, c) {
            var n, f, u, o, a, p, w, A, B = i.indexOf("."),
                M = x,
                m = S;
            for (B >= 0 && (o = Y, Y = 0, i = i.replace(".", ""), A = new h(s), p = A.pow(i.length - B), Y = o, A.c = r(W(q(p.c), p.e, "0"), 10, t, e), A.e = A.c.length), w = r(i, s, t, c ? (n = K, e) : (n = e, K)), u = o = w.length; w[--o] == 0; w.pop());
            if (!w[0]) return n.charAt(0);
            if (B < 0 ? --u : (p.c = w, p.e = u, p.s = l, p = E(p, A, M, m, t), w = p.c, a = p.r, u = p.e), f = u + M + 1, B = w[f], o = t / 2, a = a || f < 0 || w[f + 1] != null, a = m < 4 ? (B != null || a) && (m == 0 || m == (p.s < 0 ? 3 : 2)) : B > o || B == o && (m == 4 || a || m == 6 && w[f - 1] & 1 || m == (p.s < 0 ? 8 : 7)), f < 1 || !w[0]) i = a ? W(n.charAt(1), -M, n.charAt(0)) : n.charAt(0);
            else {
                if (w.length = f, a)
                    for (--t; ++w[--f] > t;) w[f] = 0, f || (++u, w = [1].concat(w));
                for (o = w.length; !w[--o];);
        ...
        function e(s, t, l) {
            var c, n, f, u, o = 0,
                ...
                p = t % J,
                w = t / J | 0;
            for (s = s.slice(); a--;) f = s[a] % J, u = s[a] / J | 0, c = w * f + u * p, n = p * f + c % J * J + o, o = (n / l | 0) + (c / J | 0) + w * u, s[a] = n % l;
        ...
        function i(s, t, l, c) {
            for (var n = 0; l--;) s[l] -= n, n = s[l] < t[l] ? 1 : 0, s[l] = n * c + s[l] - t[l];
            for (; !s[0] && s.length > 1; s.splice(0, 1));
        }
        return function(s, t, l, c, n) {
            var f, u, o, a, p, w, A, B, M, m, d, D, re, se, ue, X, ee, F = s.s == t.s ? 1 : -1,
                P = s.c,
                I = t.c;
            if (!P || !P[0] || !I || !I[0]) return new h(!s.s || !t.s || (P ? I && P[0] == I[0] : !I) ? NaN : P && P[0] == 0 || !I ? F * 0 : F / 0);
            for (B = new h(F), M = B.c = [], u = s.e - t.e, F = l + u + 1, n || (n = H, u = $(s.e / N) - $(t.e / N), F = F / N | 0), o = 0; I[o] == (P[o] || 0); o++);
            if (I[o] > (P[o] || 0) && u--, F < 0) M.push(1), a = !0;
            else {
                for (se = P.length, X = I.length, o = 0, F += 2, p = y(n / (I[0] + 1)), p > 1 && (I = e(I, p, n), P = e(P, p, n), X = I.length, se = P.length), re = X, m = P.slice(0, X), d = m.length; d < X; m[d++] = 0);
                ee = I.slice(), ee = [0].concat(ee), ue = I[0], I[1] >= n / 2 && ue++;
                do {
                    if (p = 0, f = r(I, m, X, d), f < 0) {
                        if (D = m[0], X != d && (D = D * n + (m[1] || 0)), p = y(D / ue), p > 1)
                            for (p >= n && (p = n - 1), w = e(I, p, n), A = w.length, d = m.length; r(w, m, A, d) == 1;) p--, i(w, X < A ? ee : I, A, n), A = w.length, f = 1;
                        else p == 0 && (f = p = 1), w = I.slice(), A = w.length;
                        if (A < d && (w = [0].concat(w)), i(m, w, d, n), d = m.length, f == -1)
                            for (; r(I, m, X, d) < 1;) p++, i(m, X < d ? ee : I, d, n), d = m.length
                    } else f === 0 && (p++, m = [0]);
    ...
    function le(e, r, i, s) {
        ...
        if (t = e.c[0], c = e.e, r == null) f = q(e.c), f = s == 1 || s == 2 && (c <= L || c >= U) ? ne(f, c) : W(f, c, "0");
    ...
    function he(e, r) {
        for (var i, s, t = 1, l = new h(e[0]); t < e.length; t++) s = new h(e[t]), (!s.s || (i = j(l, s)) === r || i === 0 && l.s === r) && (l = s);
        return l
    }
    ...
    R = function() {
        ...
        return function(l, c, n, f) {
            ...
            if (s.test(o)) l.s = isNaN(o) ? null : o < 0 ? -1 : 1;
            else {
                if (!n && (o = o.replace(e, function(a, p, w) {
                        return u = (w = w.toLowerCase()) == "x" ? 16 : w == "b" ? 2 : 8, !f || f == u ? p : a
                    }), f && (u = f, o = o.replace(r, "$1").replace(i, "0.$1")), c != o)) return new h(o, u);
                if (h.DEBUG) throw Error(C + "Not a" + (f ? " base " + f : "") + " number: " + c);
                l.s = null
            }
            l.c = l.e = null
        }
    ...
    function G(e, r, i, s) {
        ...
        if (a) {
            e: {
                ...
                if (s = s || r < 0 || a[u + 1] != null || (c < 0 ? f : f % p[t - c - 1]), s = i < 4 ? (o || s) && (i == 0 || i == (e.s < 0 ? 3 : 2)) : o > 5 || o == 5 && (i == 4 || s || i == 6 && (l > 0 ? c > 0 ? f / p[t - c] : 0 : a[u - 1]) % 10 & 1 || i == (e.s < 0 ? 8 : 7)), r < 1 || !a[0]) return a.length = 0, s ? (r -= e.e + 1, a[0] = p[(N - r % N) % N], e.e = -r || 0) : a[0] = e.e = 0, e;
    ...
    return g.absoluteValue = g.abs = function() {
        ...
        var i, s, t, l = this;
        if (e != null) return v(e, 0, k), r == null ? r = S : v(r, 0, 8), G(new h(l), e + l.e + 1, r);
        if (!(i = l.c)) return null;
        if (s = ((t = i.length - 1) - $(this.e / N)) * N, t = i[t])
            for (; t % 10 == 0; t /= 10, s--);
        return s < 0 && (s = 0), s
        ...
        if (e = new h(e), e.c && !e.isInteger()) throw Error(C + "Exponent not an integer: " + V(e));
        if (r != null && (r = new h(r)), n = e.e > 14, !a.c || !a.c[0] || a.c[0] == 1 && !a.e && a.c.length == 1 || !e.c || !e.c[0]) return o = new h(Math.pow(+V(a), n ? e.s * (2 - ie(e)) : +V(e))), r ? o.mod(r) : o;
        if (f = e.s < 0, r) {
            if (r.c ? !r.c[0] : !r.s) return new h(NaN);
            s = !f && a.isInteger() && r.isInteger(), s && (a = a.mod(r))
        } else {
            if (e.e > 9 && (a.e > 0 || a.e < -1 || (a.e == 0 ? a.c[0] > 1 || n && a.c[1] >= 24e7 : a.c[0] < 8e13 || n && a.c[0] <= 9999975e7))) return l = a.s < 0 && ie(e) ? -0 : 0, a.e > -1 && (l = 1 / l), new h(f ? 1 / l : l);
            Y && (l = ce(Y / N + 2))
        }
        for (n ? (i = new h(.5), f && (e.s = 1), u = ie(e)) : (t = Math.abs(+V(e)), u = t % 2), o = new h(T);;) {
            ...
            if (t) {
                ...
                u = t % 2
            } else if (e = e.times(i), G(e, e.e + 1, 1), e.e > 14) u = ie(e);
            else {
                if (t = +V(e), t === 0) break;
                u = t % 2
            }
        ...
        if (!f || !u) {
            ...
            if (!o[0] || !a[0]) return a[0] ? (e.s = -r, e) : new h(o[0] ? c : S == 3 ? -0 : 0)
        }
        ...
        var i, s, t, l, c, n, f, u, o, a, p, w, A, B, M, m = this,
            d = m.c,
            D = (e = new h(e, r)).c;
        if (!d || !D || !d[0] || !D[0]) return !m.s || !e.s || d && !d[0] && !D || D && !D[0] && !d ? e.c = e.e = e.s = null : (e.s *= m.s, !d || !D ? e.c = e.e = null : (e.c = [0], e.e = 0)), e;
        for (s = $(m.e / N) + $(e.e / N), e.s *= m.s, f = d.length, a = D.length, f < a && (A = d, d = D, D = A, t = f, f = a, a = t), t = f + a, A = []; t--; A.push(0));
        for (B = H, M = J, t = a; --t >= 0;) {
            for (i = 0, p = D[t] % M, w = D[t] / M | 0, c = f, l = t + c; l > t;) u = d[--c] % M, o = d[c] / M | 0, n = w * u + o * p, u = p * u + n % M * M + A[l] + i, i = (u / B | 0) + (n / M | 0) + w * o, A[l--] = u % B;
            A[l] = i
        }
        ...
        for (t = n.length, r = f.length, t - r < 0 && (i = f, f = n, n = i, r = t), t = 0; r;) t = (n[--r] = n[r] + f[r] + t) / H | 0, n[r] = H === n[r] ? 0 : n[r] % H;
        return t && (n = [t].concat(n), ++c), oe(e, n, c)
    }, g.precision = g.sd = function(e, r) {
        var i, s, t, l = this;
        if (e != null && e !== !!e) return v(e, 1, k), r == null ? r = S : v(r, 0, 8), G(new h(l), e, r);
        if (!(i = l.c)) return null;
        ...
        var e, r, i, s, t, l = this,
            c = l.c,
            n = l.s,
            f = l.e,
            u = x + 4,
            o = new h("0.5");
        if (n !== 1 || !c || !c[0]) return new h(!n || n < 0 && (!c || c[0]) ? NaN : c ? l : 1 / 0);
        ...
        var s, t = this;
        if (i == null) e != null && r && typeof r == "object" ? (i = r, r = null) : e && typeof e == "object" ? (i = e, e = r = null) : i = te;
        else if (typeof i != "object") throw Error(C + "Argument not an object: " + i);
        ...
        var r, i, s, t, l, c, n, f, u, o, a, p, w = this,
            A = w.c;
        if (e != null && (n = new h(e), !n.isInteger() && (n.c || n.s !== 1) || n.lt(T))) throw Error(C + "Argument " + (n.isInteger() ? "out of range: " : "not an integer: ") + V(n));
        if (!A) return new h(w);
        for (r = new h(T), u = i = new h(T), s = f = new h(T), p = q(A), l = r.e = p.length - w.e - 1, r.c[0] = ae[(c = l % N) < 0 ? N + c : c], e = !e || n.comparedTo(r) > 0 ? l > 0 ? r : u : n, c = z, z = 1 / 0, n = new h(p), f.c[0] = 0; o = E(n, r, 0, 1), t = i.plus(o.times(s)), t.comparedTo(e) != 1;) i = s, s = t, u = f.plus(o.times(t = u)), f = t, r = n.minus(o.times(t = r)), n = t;
        return t = E(e.minus(i), s, 0, 1), f = f.plus(t.times(u)), i = i.plus(t.times(s)), f.s = u.s = w.s, l = l * 2, a = E(u, s, l, S).minus(w).abs().comparedTo(E(f, i, l, S).minus(w).abs()) < 1 ? [u, s] : [f, i], z = c, a
    }, g.toNumber = function() {
        return +V(this)
        ...
        var r, i = this,
            s = i.s,
            t = i.e;
        return t === null ? s ? (r = "Infinity", s < 0 && (r = "-" + r)) : r = "NaN" : (e == null ? r = t <= L || t >= U ? ne(q(i.c), t) : W(q(i.c), t, "0") : e === 10 && fe ? (i = G(new h(i), x + t + 1, S), r = W(q(i.c), i.e, "0")) : (v(e, 2, K.length, "Base"), r = _(W(q(i.c), t, "0"), 10, e, s, !0)), s < 0 && i.c[0] && (r = "-" + r)), r
...
function j(O, E) {
    ...
    if (x != S) return x;
    if (_ = x < 0, R = L == U, !g || !T) return R ? 0 : !g ^ _ ? 1 : -1;
    if (!R) return L > U ^ _ ? 1 : -1;
    for (S = (L = g.length) < (U = T.length) ? L : U, x = 0; x < S; x++)
        if (g[x] != T[x]) return g[x] > T[x] ^ _ ? 1 : -1;
    return L == U ? 0 : L > U ^ _ ? 1 : -1
}

function v(O, E, _, R) {
    if (O < E || O > _ || O !== y(O)) throw Error(C + (R || "Argument") + (typeof O == "number" ? O < E || O > _ ? " out of range: " : " not an integer: " : " not a primitive number: ") + String(O))
}
