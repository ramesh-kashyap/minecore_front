...
function et(e, t) {
    V({
        ...
        i.addTimelineLayer({
            ...
            if (r.app === e && r.inspectorId === _) {
                var n = r.nodeId;
                x(t, n), r.state = nt(ct(t._modules, n), n === "root" ? t.getters : t._makeLocalGettersCache, n)
            }
...
v.prototype.subscribe = function(t, i) {
    return A(t, this._subscribers, i)
};
v.prototype.subscribeAction = function(t, i) {
    var r = typeof t == "function" ? {
        before: t
    } : t;
    return A(r, this._actionSubscribers, i)
};
