...
>
                     <canvas data-zr-dom-id="zr_0" width="664" height="150" style="position: absolute; left: 0px; top: 0px; width: 443px; height: 100px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                  </div>
                  <div class=""  style={{
    position: "absolute",
    display: "block",
    ...
    strokeWidth: "40px"
                              ...
                              <path d="M 520 520 m 0, -500 a 500, 500 0 1, 1 0, 1000 a 500, 500 0 1, 1 0, -1000" class="van-circle__hover" stroke="#30BD64" style="stroke: rgb(48, 189, 100); stroke-width: 41px; stroke-dasharray: 0px, 3140px;"></path>
                           </svg>
