                    ...
                    <div class="van-pull-refresh__track" style={{ transitionDuration: '0ms' }}>
                        ...
                        <div data-v-0b60bd9b="" class="info-top">
                            <div data-v-0b60bd9b="" class="box">
                                ...
                                <ul data-v-0b60bd9b="" class="income">
                                    ...
                                    <li data-v-0b60bd9b=""onClick={() => handleNavigation('pledgerecord')} >
                                    ...
                                    <li data-v-0b60bd9b=""onClick={() => handleNavigation('releasedrecord')}>
                        ...
                        <div data-v-0b60bd9b="" class="info-cen">
                            <ul data-v-0b60bd9b="" class="tab">
                                <li data-v-0b60bd9b="" className={activeTab === 'asset' ? 'on' : ''}
                                    onClick={() => setActiveTab('asset')}>Asset List</li>
                                <li data-v-0b60bd9b="" className={activeTab === 'earnings' ? 'on' : ''}
                                    onClick={() => setActiveTab('earnings')}>My earnings</li>
                            </ul>
                            {activeTab === 'asset' && (
                                <div data-v-0b60bd9b="">
                            ...
                            {activeTab === 'earnings' && (
                                <ul data-v-657c427c="" data-v-0b60bd9b="" class="list">
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Total revenue(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Today's earnings(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Accumulated equipment revenue(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Today's equipment revenue(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Cumulative computing power mining income(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Today's computing power mining income(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Cumulative team income(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                    <li data-v-657c427c="">
                                        <div data-v-657c427c="" class="title">Today's team income(USDT)</div>
                                        <div data-v-657c427c="" class="val">0</div>
                                        <p data-v-657c427c="">≈0 MCE</p>
                                    </li>
                                </ul>
