...
const DepositRecord = () => {
 ...
 const invests = async () => {
  ...
  const dataArray = res.data?.data || res.data?.buy_funds || [];

    if (Array.isArray(dataArray)) {
      setInvestData(dataArray);
    } else {
      setInvestData([]);
    }
      ...
      <div data-v-72d7289a="" data-v-c77b46c7="" class="page">
         <div data-v-72d7289a="" class="headers">
            <div data-v-7401f0fe="" data-v-72d7289a="" class="inside-header">
               ...
               <div data-v-7401f0fe="" class="title overflow1">
                  Deposit Record
               </div>
            ...
            <div data-v-72d7289a="" class="van-pull-refresh scroll" id="pageScroll">
               ...
               >
                  ...
                  <div
                     ...
                     data-v-c77b46c7=""
                     role="feed"
                     class="van-list van-list container"
                     aria-busy="false"
                  >
               ...
               <div
                  ...
                  style={{ bottom: "1.3rem", right: "0.2rem" }}
               ></div>
            </div>

            <div data-v-72d7289a="" class="footer"></div>
         </div>
      </div>
   );
};
