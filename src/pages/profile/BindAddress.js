...
const BindAddress = () => {
    ...
    const [activeChain, setActiveChain] = useState('ERC20');
    return (
                    ...
                    <div data-v-8be212fc="" class="container">
                        <div data-v-8be212fc="" class="box-con">
                            ...
                            <div data-v-8be212fc="" class="inp-con" onClick={openPopup}>
                                <div data-v-8be212fc="" class="inp"><span data-v-8be212fc="">USDT</span><img data-v-8be212fc="" src="data:image/png;base64," alt="" /></div>
                            </div>
                        </div>
                        <div data-v-8be212fc="" class="box-con">
                            ...
                            <div data-v-8be212fc="" class="chain-list">
                                <div
                                    class={`chain-item ${activeChain === 'ERC20' ? 'active' : ''}`}
                                    onClick={() => setActiveChain('ERC20')}
                                >
                                    ERC20
                                </div>
                        ...
                        <div data-v-8be212fc="" class="box-con">
                            ...
                            <div data-v-8be212fc="" class="inp-con"><input data-v-8be212fc="" class="inp" placeholder="Please enter a withdrawal address" /></div>

                        </div>
                        <div data-v-8be212fc="" class="submit-bt">
                            <button data-v-34dc7cc4="" data-v-8be212fc="" type="button" class="van-button van-button--default van-button--normal com-btn on submit-btn">
                                    ...
                                    <div class="van-picker-column">
                                        <ul class="van-picker-column__wrapper" style={{ transform: 'translate3d(0px, 110px, 0px)', transitionDuration: '0ms', transitionProperty: 'none' }}>
                                            ...
                                            <li role="button" tabindex="0" class="van-picker-column__item" style={{ height: '44px' }}>
                                                <div class="van-ellipsis">USDC</div>
                                            </li>
                                            <li role="button" tabindex="0" class="van-picker-column__item" style={{ height: '44px' }}>
                                                <div class="van-ellipsis">TRX</div>
                                            </li>
                                            <li role="button" tabindex="0" class="van-picker-column__item" style={{ height: '44px' }}>
                                                <div class="van-ellipsis">DAI</div>
                                            </li>
                                            <li role="button" tabindex="0" class="van-picker-column__item" style={{ height: '44px' }}>
                                                <div class="van-ellipsis">BNB</div>
                                            </li>
                                            <li role="button" tabindex="0" class="van-picker-column__item" style={{ height: '44px' }}>
                                                <div class="van-ellipsis">BTC</div>
                                            </li>
                                            <li role="button" tabindex="0" class="van-picker-column__item" style={{ height: '44px' }}>
                                                <div class="van-ellipsis">ETH</div>
                                            </li>
                                        </ul>
                                    </div>
